...
parameters = [1800, 8, 13, 7, 3.8]

x = np.arange(len(categories))
width = 0.25
fig, ax1 = plt.subplots(figsize=(10, 6))

bars1 = ax1.bar(x - width, triviaqa_acc, width, label='TriviaQA', color='#2C91C6')
bars2 = ax1.bar(x, hotpotqa_acc, width, label='HotpotQA', color='#F29C38')
bars3 = ax1.bar(x + width, nq_acc, width, label='NQ', color='#D3D3D3')
...
ax2.set_yscale('log')
ax2.set_ylabel('Parameters (in billions)', color='black', fontsize=14)
...
ax1.legend(loc='upper right', bbox_to_anchor=(1, 0.93), fontsize=14) 

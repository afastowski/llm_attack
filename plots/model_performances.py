...
# Creating the bars for accuracy
...
# Creating second y-axis for parameters
ax2 = ax1.twinx()

# Plotting the parameters line with log scale on the right
...
plt.tight_layout()
plt.show()
plt.savefig("drift/plots/model_performances.pdf")
